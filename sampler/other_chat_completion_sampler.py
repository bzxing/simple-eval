...
class OtherChatCompletionSampler(SamplerBase):
    """
    ...
    def __init__(
        ...
        *,
        ...
        # self.client = OpenAI(base_url="https://api.together.xyz/v1")
        self.client = OpenAI(base_url="https://directors-beginner-install-domain.trycloudflare.com/v1")
